...
|     |     |     |
| --- | --- | --- |
| Novice | Active. | Test [Volonté ← Volonté], dissiper les effets en cours d’un pouvoir sur une créature, ou lui-même, à condition qu’il soit en mesure d’utiliser la magie. C’est la Volonté du Mystique qui a déchaîné le pouvoir qui est utilisée comme résistance lors du test. |
